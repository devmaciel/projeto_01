				...
				<h3><i class="fa fa-user" aria-hidden="true"></i> Sobre o autor:</h3>
					<div class="autor-box-portal">
						...
						<div class="texto-autor-portal text-center">
							...
							<p><?php
								if(strlen($infoSite['descricao']) > 300){
								echo substr($infoSite['descricao'],0,300).'...';
								?>
							<div><a class="leia-mais-autor" href="<?php INCLUDE_PATH; ?>sobre-autor">Leia mais</a></div>
							<?php }else{ echo $infoSite['descricao']; }
							?></p>
